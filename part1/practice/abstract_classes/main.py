...
class Car(Transport):
    def start_engine(self):
        print('Катер заурчал двигателем')

    def stop_engine(self):
        print('Двигатель стоит с заглушенным двигателем')

    def move(self):
        print('Катер едет к цели назначения')

    def stop(self):
        print('Катер остановилась')
...
class Electroscooter(Transport):
    ...
    def move(self):
        print('Прохожие в ужасе разбегаються от очередного камикадзе')
